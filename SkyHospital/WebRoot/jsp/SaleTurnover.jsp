                    ...
                    <thead>
                        <tr>
                          <th class="head1 nosort"><input type="checkbox" /></th>
                          	<th class="head1">销售流水号</th>
                            <th class="head1">销售日期</th>
                            <th class="head1">会员ID</th>
                            <th class="head1">销售金额</th>
                            <th class="head1">实收金额</th>
                            <th class="head1">应收金额</th>
                            <th class="head1">减免金额</th>
                            <th class="head1">减免说明</th>
                            <th class="head1">支付方式</th>
                            <th class="head1">备注</th>
                            <th class="head1">结算日期</th>
                            <th>修改</th>
                        </tr>
                    </thead>
