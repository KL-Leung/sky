                    ...
                    <thead>
                        <tr>
                          <th class="head1 nosort"><input type="checkbox" /></th>
                            ...
                            <th class="head1">商品种类</th>
                            
                            <th class="head1">药品分类</th>
                            <th class="head1">自定义类</th>
                            <th class="head1">自编码</th>
                            <th class="head1">报警量</th>
                            <th class="head1">批准文号</th>
                            <th class="head1">装箱</th>
                            <th class="head1">拆零数量</th>
							<th class="head1">拆零规格</th>
                            <th class="head1">拆零单位</th>
                            <th>修改</th>
                        </tr>
                    </thead>
