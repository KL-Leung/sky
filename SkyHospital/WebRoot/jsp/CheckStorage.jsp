             ...
             <div class="contenttitle2">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
                    ...
                    <thead>
                        <tr>
                          <th class="head1 nosort"><input type="checkbox" /></th>
                            ...
                            <th class="head1">入库日期</th>
                            <th class="head1">促销提成</th>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="med" items="${list}" varStatus="status">
                          <tr class="gradeX">
                          <td align="center"><span class="center">
                            ...
                            <td class="center">${med.specification}</td>
                            <td>${med.manufacturerid}</td>
                            <td>${med.unitid}</td>
                            <td>${med.dosageformsid}</td>
                            <td class="center">${med.goodskindid}</td>
                            <td>${med.mckid}</td>
                            <td>${med.tinyunitid}</td>
                            <td>${med.modifierid}</td>
                            <td>${med.medicinekindid}</td>
                            <td>${med.tinynumber}</td>
                            <td class="center">${med.tinyspecification}</td>
