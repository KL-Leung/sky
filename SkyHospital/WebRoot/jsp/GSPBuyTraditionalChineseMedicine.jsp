                    ...
                    <thead>
                        <tr>
                          <th class="head1 nosort"><input type="checkbox" /></th>
                          	<th class="head1">品名</th>
                            <th class="head1">规格</th>
                            <th class="head1">批号</th>
                            
                            <th class="head1">产地</th>
                            <th class="head1">生产日期</th>
                            <th class="head1">生产厂商</th>
                            <th class="head1">供货单位</th>
                            <th class="head1">到货数量</th>
                            
                            <th class="head1">验收合格数量</th>
                            <th class="head1">单位</th>
                            <th class="head1">验收员</th>
                         	<th class="head1">验收结论</th>
                            
                            <th class="head1">验收日期</th>
